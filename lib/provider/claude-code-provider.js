...
import { getAgents } from '../agent-parser.js';
...
export class ClaudeCodeProvider extends BaseProvider {
  ...
  async executeNode(node, context, runId) {
    ...
    // Determine allowed tools — agent definition overrides default
    const defaultTools = ['Edit', 'Write', 'Read', 'Glob', 'Grep', 'Bash', 'NotebookEdit'];
    const allowedTools = agentDef?.allowedTools?.length ? agentDef.allowedTools : defaultTools;
