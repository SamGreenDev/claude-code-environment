...
const RULE_TEMPLATES = {
  'rest api': {
    ...
    nodes: [
      ...
      { id: 'n5', label: 'Reviewer', agentType: 'code-reviewer', prompt: 'Review the complete API implementation for code quality, error handling, and best practices. Check for consistency and maintainability. List all issues found.', config: { timeout: 300, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
      { id: 'n6', label: 'Final Fixes', agentType: 'code-implementer', prompt: 'Review the code reviewer findings and fix all identified issues. Verify the implementation is complete, all tests pass, and the API is production-ready.', config: { timeout: 600, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
    ],
    edges: [
      { id: 'e-n1-n2', from: 'n1', to: 'n2', type: 'sequential' },
  ...
  'react': {
    ...
    nodes: [
      ...
      { id: 'n4', label: 'Reviewer', agentType: 'code-reviewer', prompt: 'Review the React implementation for component design, accessibility, performance patterns, and code quality. List all issues found.', config: { timeout: 300, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
      { id: 'n5', label: 'Final Fixes', agentType: 'code-implementer', prompt: 'Review the code reviewer findings and fix all identified issues. Verify components render correctly, tests pass, and the app is production-ready.', config: { timeout: 600, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
    ],
    edges: [
      { id: 'e-n1-n2', from: 'n1', to: 'n2', type: 'sequential' },
      { id: 'e-n2-n3', from: 'n2', to: 'n3', type: 'sequential' },
  ...
  'refactor': {
    ...
    nodes: [
      ...
      { id: 'n4', label: 'Reviewer', agentType: 'code-reviewer', prompt: 'Review the refactored code for quality, consistency, and that behavior is preserved. List all issues and regressions found.', config: { timeout: 300, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
      { id: 'n5', label: 'Final Fixes', agentType: 'code-implementer', prompt: 'Review the code reviewer findings and fix all identified issues. Ensure all tests pass and no regressions were introduced by the refactoring.', config: { timeout: 600, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
    ],
    edges: [
      { id: 'e-n1-n2', from: 'n1', to: 'n2', type: 'sequential' },
      { id: 'e-n2-n3', from: 'n2', to: 'n3', type: 'sequential' },
  ...
  'security': {
    ...
    nodes: [
      ...
      { id: 'n2', label: 'Security Auditor', agentType: 'security-reviewer', prompt: 'Perform a thorough security review based on the research. Check for OWASP Top 10 vulnerabilities, injection risks, auth issues, and data exposure. List all findings.', config: { timeout: 600, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
      ...
      { id: 'n4', label: 'Verification', agentType: 'security-reviewer', prompt: 'Verify that all security fixes are correct and complete. List any remaining vulnerabilities or new issues introduced.', config: { timeout: 300, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
      { id: 'n5', label: 'Final Fixes', agentType: 'code-implementer', prompt: 'Review the verification findings and fix any remaining security issues. Ensure all vulnerabilities are fully resolved and the codebase is hardened.', config: { timeout: 600, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
    ],
    edges: [
      { id: 'e-n1-n2', from: 'n1', to: 'n2', type: 'sequential' },
      { id: 'e-n2-n3', from: 'n2', to: 'n3', type: 'sequential' },
  ...
  'fullstack': {
    ...
    nodes: [
      ...
      { id: 'n5', label: 'Reviewer', agentType: 'code-reviewer', prompt: 'Review the complete full-stack implementation for quality, consistency between frontend and backend, and best practices. List all issues found.', config: { timeout: 300, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
      { id: 'n6', label: 'Final Fixes', agentType: 'code-implementer', prompt: 'Review the code reviewer findings and fix all identified issues. Verify frontend-backend integration works, all tests pass, and the feature is production-ready.', config: { timeout: 600, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
    ],
    edges: [
      { id: 'e-n1-n2', from: 'n1', to: 'n2', type: 'sequential' },
