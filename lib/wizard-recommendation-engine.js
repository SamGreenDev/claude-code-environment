...
const RULE_TEMPLATES = {
  'rest api': {
    ...
    nodes: [
      ...
      { id: 'n3', label: 'Implementer', agentType: 'general-purpose', prompt: 'Implement the REST API based on the architecture design. Create all route handlers, models, middleware, and configuration files.', config: { timeout: 600, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
      { id: 'n4', label: 'Test Writer', agentType: 'general-purpose', prompt: 'Write comprehensive tests for all API endpoints including unit tests and integration tests. Cover success cases, error handling, and edge cases.', config: { timeout: 300, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
  ...
  'react': {
    ...
    nodes: [
      ...
      { id: 'n2', label: 'Component Builder', agentType: 'general-purpose', prompt: 'Implement the React components, hooks, and state management based on the plan. Create reusable, accessible components.', config: { timeout: 600, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
      { id: 'n3', label: 'Test Writer', agentType: 'general-purpose', prompt: 'Write tests for all React components and hooks. Include unit tests, integration tests, and snapshot tests.', config: { timeout: 300, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
  ...
  'security': {
    ...
    nodes: [
      ...
      { id: 'n3', label: 'Fixer', agentType: 'general-purpose', prompt: 'Fix all identified security vulnerabilities. Apply secure coding patterns, add input validation, and harden configuration.', config: { timeout: 600, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
  ...
  'fullstack': {
    ...
    nodes: [
      ...
      { id: 'n2', label: 'Backend Dev', agentType: 'general-purpose', prompt: 'Implement the backend: API endpoints, database models, business logic, and middleware.', config: { timeout: 600, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
      { id: 'n3', label: 'Frontend Dev', agentType: 'general-purpose', prompt: 'Implement the frontend: UI components, state management, API integration, and routing.', config: { timeout: 600, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
      { id: 'n4', label: 'Test Writer', agentType: 'general-purpose', prompt: 'Write comprehensive tests for both frontend and backend. Include unit, integration, and end-to-end tests.', config: { timeout: 300, retries: 1 }, provider: 'claude-code', model: '', mcpServers: [] },
